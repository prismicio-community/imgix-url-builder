 ...
 *
 * The `dpr` URL parameter will be applied for each `srcset` entry. If a `dpr` parameter is provided
 ...
 * @param params - An object of Imgix URL API parameters. The `pixelDensities` parameter defines the
