...
# Clone your fork
git clone git@github.com:<your-username>/imgix-url-builder.git
...
## `imgix-url-builder` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio-community/imgix-url-builder/issues/new/choose
