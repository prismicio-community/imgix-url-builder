...
This package is primarily maintained by [Prismic](https://prismic.io)[^1]. External contributions are welcome. Ask for help by [opening an issue](https://github.com/prismicio-community/imgix-url-builder/issues/new/choose), or request a review by opening a pull request.
...
This package provides JavaScript/TypeScript Imgix URL builders for browsers and Node.js. It has two entry points:

- `imgix-url-builder` — browser-safe utilities (no Node.js crypto)
- `imgix-url-builder/node` — includes signed URL utilities using Node.js crypto

The `src/types.generated.ts` file is generated from `imgix-url-params`. Run `node --run gen` to regenerate it.

## :construction_worker: Develop

> [!NOTE]
> It's highly recommended to discuss your changes with the Prismic team before starting by [opening an issue](https://github.com/prismicio-community/imgix-url-builder/issues/new/choose).[^2]
>
> A short discussion can accellerate your work and ship it faster.

```sh
# Clone and prepare the project.
git clone git@github.com:prismicio-community/imgix-url-builder.git
cd imgix-url-builder
npm install
...
npm install imgix-url-builder@pr-101
...
This repository uses [Release Please](https://github.com/googleapis/release-please). To publish changes in `main`, merge [the pending Release Please PR](https://github.com/prismicio-community/imgix-url-builder/pulls?q=is%3Apr+is%3Aopen+label%3A%22autorelease%3A+pending%22).
