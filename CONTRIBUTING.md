...
# Clone your fork
git clone git@github.com:<your-username>/imgix-ts.git
...
## `imgix-ts` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio-community/imgix-ts/issues/new/choose
