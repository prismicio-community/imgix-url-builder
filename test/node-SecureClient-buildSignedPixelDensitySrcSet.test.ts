...
it("builds a signed pixel density srcset", () => {
	const client = new SecureClient({
		baseURL: "https://example.com",
		secureURLToken: "token",
	})

	const actual = client.buildSignedPixelDensitySrcSet("https://example.com/image.png", {
...
it("builds a signed pixel density srcset with params", () => {
	const client = new SecureClient({
		baseURL: "https://example.com",
		secureURLToken: "token",
	})
