...
it("builds a signed pixel density srcset for a path", () => {
	const client = new SecureClient({
		baseURL: "https://example.com",
		secureURLToken: "token",
	})

	const actual = client.buildSignedPixelDensitySrcSetForPath("folder/image.png", {
...
it("builds a signed pixel density srcset for a path with params", () => {
	const client = new SecureClient({
		baseURL: "https://example.com",
		secureURLToken: "token",
	})
